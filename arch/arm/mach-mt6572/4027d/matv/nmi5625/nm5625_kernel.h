...
#define NM5625_PWR_2P8_CTL   	NMI_POWER_VDDIO_CTL
#define NM5625_PWR_1P2_CTL 	NMI_POWER_VCORE_CTL
#define NM5625_ATV_RESET_CTL 	NMI_RESET_CTL
#define NM5625_ATV_I2C_READ 	NMI_I2C_READ
#define NM5625_ATV_I2C_WRITE 	NMI_I2C_WRITE
