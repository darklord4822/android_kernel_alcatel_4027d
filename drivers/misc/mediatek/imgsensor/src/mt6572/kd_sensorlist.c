 ...
 * i2c relative start
********************************************************************************/
//BEGIN: add by xiaopu.zhu for show camera info in MINISW screen, FR803765
char Front_Camera_Name[256]="No front Camera found";
...
char Back_Camera_Name[256]="No back Camera found";
...
//END: add by xiaopu.zhu for show camera info in MINISW screen, FR803765
/*******************************************************************************
* CAMERA_HW_i2c_probe
********************************************************************************/
