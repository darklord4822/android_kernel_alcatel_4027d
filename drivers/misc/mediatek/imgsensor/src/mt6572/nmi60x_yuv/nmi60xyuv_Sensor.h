 ...
 ****************************************************************************/
/* SENSOR FULL SIZE */
#ifndef _NMI60X_YUV_SENSOR_H
#define _NMI60X_YUV_SENSOR_H
...
/* SENSOR FULL SIZE */
#define NMI60X_IMAGE_SENSOR_FULL_WIDTH	   (320)
#define NMI60X_IMAGE_SENSOR_FULL_HEIGHT	  (240)


/* SENSOR PV SIZE */
#define NMI60X_IMAGE_SENSOR_PV_WIDTH   (320)
#define NMI60X_IMAGE_SENSOR_PV_HEIGHT  (240)


//export functions
UINT32 NMI60XOpen(void);
UINT32 NMI60XGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution);
UINT32 NMI60XGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 NMI60XControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
