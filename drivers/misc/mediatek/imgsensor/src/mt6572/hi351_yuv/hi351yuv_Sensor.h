...
#define HI351_PV_PERIOD_LINE_NUMS			(1024+320)//(480+320)
#define HI351_FULL_PERIOD_PIXEL_NUMS		(2048)	
#define HI351_FULL_PERIOD_LINE_NUMS 		(1536+320)

#define HI351_PV_EXPOSURE_LIMITATION		(1024)                //640
#define HI351_FULL_EXPOSURE_LIMITATION		(1536)

#define HI351_IMAGE_SENSOR_PV_WIDTH   		(1024)       //640
#define HI351_IMAGE_SENSOR_PV_HEIGHT  		(768)       //480
...
#define HI351_FULL_GRAB_WIDTH				(HI351_IMAGE_SENSOR_FULL_WIDTH - 16)       //32
#define HI351_FULL_GRAB_HEIGHT				(HI351_IMAGE_SENSOR_FULL_HEIGHT - 12)    //24
