...
//zhao.li@tcl ATV
#ifdef NMI5625
#include "cust_matv_comm.h"//zhao.li@tcl ATV
#endif
//zhao.li@tcl ATV end
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	{	
		...
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			GC0329_write_cmos_sensor(0x33, 0x00);//zhao.li@tcl change this from 0x00 to 0x20 for bug 474328
		else
	...
	else 
	{
		GC0329_write_cmos_sensor(0xfe, 0x01);
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			GC0329_write_cmos_sensor(0x33, 0x20);//zhao.li@tcl change this from 0x00 to 0x20 for bug 474328//leslie 0x00
		else
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x77, 0x4b);
	GC0329_write_cmos_sensor(0x78, 0x42);
	GC0329_write_cmos_sensor(0x79, 0x44);
	//GC0329_write_cmos_sensor(0x42, 0xfc);

	////////////////////analog////////////////////
	GC0329_write_cmos_sensor(0x0a, 0x02);
	GC0329_write_cmos_sensor(0x0c, 0x02);
	GC0329_write_cmos_sensor(0x17, 0x17); // 16   lanking 20120423  mirror setting jiangjingjing modify for Defect 122528-20150116
	...
	GC0329_write_cmos_sensor(0x1f, 0x08); // c0  20120720
	...
	GC0329_write_cmos_sensor(0x44, 0xa2);//zhao.li@tcl change a0 to a2
	...
	GC0329_write_cmos_sensor(0x82, 0x90); 
	GC0329_write_cmos_sensor(0x83, 0x05);  // add by lanking 20120423
...
if(gc0329_module==1)
		{
	GC0329_write_cmos_sensor(0xb3, 0x42);	
		}
	else
		{
	GC0329_write_cmos_sensor(0xb3, 0x42);	
...
{     
	...
	GC0329_write_cmos_sensor(0xd2, 0x2e);	
       GC0329_write_cmos_sensor(0xd3, 0x40);//44
}
else
{
       GC0329_write_cmos_sensor(0xd1, 0x2e);
...
if(gc0329_module==1)
{
	GC0329_write_cmos_sensor(0x7b, 0x7e);
}
else
{
	GC0329_write_cmos_sensor(0x7b, 0x7e);
	...
	GC0329_write_cmos_sensor(0x13, 0x54);//0x50
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xb0);
	GC0329_write_cmos_sensor(0x22, 0x48);///48
	...
	GC0329_write_cmos_sensor(0x51, 0x24);
	GC0329_write_cmos_sensor(0x52, 0x18);
...
if(gc0329_module==1)
{
	GC0329_write_cmos_sensor(0x66, 0xfc);//0xf0
}
else
{
	GC0329_write_cmos_sensor(0x66, 0xfc);//0xf0
}
	GC0329_write_cmos_sensor(0x67, 0x88);
	GC0329_write_cmos_sensor(0x68, 0x64);//0x68
	GC0329_write_cmos_sensor(0x69, 0xb0);
...
if(gc0329_module==1)
{
	...
	GC0329_write_cmos_sensor(0xa2 , 0x56);
	GC0329_write_cmos_sensor(0xa3 , 0x00);
	GC0329_write_cmos_sensor(0xa8 , 0x2c);
	GC0329_write_cmos_sensor(0xa9 , 0x23);
	GC0329_write_cmos_sensor(0xaa , 0x20);
	GC0329_write_cmos_sensor(0xab , 0x27);
	GC0329_write_cmos_sensor(0xac , 0x20);
	GC0329_write_cmos_sensor(0xad , 0x20);
	GC0329_write_cmos_sensor(0xae , 0x29);
	GC0329_write_cmos_sensor(0xaf , 0x20);
	GC0329_write_cmos_sensor(0xb0 , 0x20);
	GC0329_write_cmos_sensor(0xb1 , 0x27);
	GC0329_write_cmos_sensor(0xb2 , 0x20);
	GC0329_write_cmos_sensor(0xb3 , 0x20);
	GC0329_write_cmos_sensor(0xb4 , 0x5b);
	GC0329_write_cmos_sensor(0xb5 , 0x20);
	GC0329_write_cmos_sensor(0xb6 , 0x24);
	GC0329_write_cmos_sensor(0xba , 0x43);
	GC0329_write_cmos_sensor(0xbb , 0x20);
	GC0329_write_cmos_sensor(0xbc , 0x20);
	GC0329_write_cmos_sensor(0xc0 , 0x09);
	GC0329_write_cmos_sensor(0xc1 , 0x00);
	GC0329_write_cmos_sensor(0xc2 , 0x02);
	GC0329_write_cmos_sensor(0xc6 , 0x0c);
	GC0329_write_cmos_sensor(0xc7 , 0x01);
	GC0329_write_cmos_sensor(0xc8 , 0x00);
	GC0329_write_cmos_sensor(0xb7 , 0x1b);
	GC0329_write_cmos_sensor(0xb8 , 0x20);
	GC0329_write_cmos_sensor(0xb9 , 0x20);
	GC0329_write_cmos_sensor(0xbd , 0x35);
	GC0329_write_cmos_sensor(0xbe , 0x20);
	GC0329_write_cmos_sensor(0xbf , 0x20);
	GC0329_write_cmos_sensor(0xc3 , 0x1e);
	GC0329_write_cmos_sensor(0xc4 , 0x20);
	GC0329_write_cmos_sensor(0xc5 , 0x20);
	GC0329_write_cmos_sensor(0xc9 , 0x20);
	GC0329_write_cmos_sensor(0xca , 0x20);
...
UINT32 GC0329GetSensorID(UINT32 *sensorID)
{
    ...
    int i;
#if 0
//add by jinlin.Hu for atv-dtv out
    #ifdef NMI5625
	if (g_bIsAtvStart) {
		*sensorID = GC0329_SENSOR_ID;
		return ERROR_NONE;
	}
    #endif
//add end 
    ...
    if(sensor_id != GC0329_SENSOR_ID)
    {
	    *sensorID=0xFFFFFFFF;//zhao.li@tcl add for gc0329 sensor id check
    ...
    *sensorID = sensor_id;
	...
	sprintf(Front_Camera_Name,"Vender:  Qtech \nSensor ID:  0x%X \nSensor name:  GC0329 \nResolution:  0.3M ",
...
///////////////////////////////////////////////
	...
	GC0329_write_cmos_sensor(0xfe,0x00);	
	GC0329_write_cmos_sensor(0x90,0x00);																																																																									
	GC0329_write_cmos_sensor(0x95,0x32);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(GC0329_RGB_Gamma_m3);//0:use default
}
        	...
        	if (sensor_id == GC0329_SENSOR_ID)
				{
	            	printk("GC0329 Sensor id = %x\n", sensor_id);
//zhao.li@tcl add
				gc0329_module= mt_get_gpio_in(GPIO_SUB_CAMERA_ID_PIN);
#ifdef GC0329YUV_DEBUG
				if(gc0329_module==1)
			{
					//E-welly module in soul4 1st source 
					SENSORDB("-------------[GC0329YUV] E-welly module---------------\n");
					}
				else
					{
					//ST module in soul4 2nd source
					//gc0329_module=1;//for test
					SENSORDB("-------------[GC0329YUV] ST module---------------\n");
					}
#endif				
//add end			
	               	break;
...

{
	...
	//zhao.li@tcl add for bug 482987
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0x17, 0x17); //14  jiangjingjing modify for Defect 122528-20150116
	//zhao.li@tcl add for bug 482987 end
...

{
	...
	//zhao.li@tcl add for bug 482987
	//GC0329_SET_PAGE0;
	//GC0329_write_cmos_sensor(0x17, 0x16);
	//zhao.li@tcl add for bug 482987 end
    image_window->GrabStartX = IMAGE_SENSOR_VGA_GRAB_PIXELS;
    image_window->GrabStartY = IMAGE_SENSOR_VGA_GRAB_LINES;
...
//tcl@zhao.li add this for video
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorFullResolutionY=IMAGE_SENSOR_FULL_HEIGHT;//zhao.li@tcl change this for bug 474328
    ...
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV;//UYVY;//zhao.li@tcl modify this SENSOR_OUTPUT_FORMAT_YUYV;
...
//zhao.li@tcl add end	
    ...
    //zhao.li@tcl del case MSDK_SCENARIO_ID_VIDEO_CAPTURE_MPEG4:
    ...
    //zhao.li@tcl del case MSDK_SCENARIO_ID_CAMERA_CAPTURE_MEM:
        pSensorInfo->SensorClockFreq=12;
        pSensorInfo->SensorClockDividCount= 3;
        pSensorInfo->SensorClockRisingCount=0;
        pSensorInfo->SensorClockFallingCount=2;
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
    //zhao.li@tcl del case MSDK_SCENARIO_ID_VIDEO_CAPTURE_MPEG4:
    //zhao.li@tcl for bug 482987 case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
    //zhao.li@tcl del case MSDK_SCENARIO_ID_CAMERA_CAPTURE_MEM:
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2f, 0x02);   //exp level 2  10.00fps //348
			GC0329_write_cmos_sensor(0x30, 0xd0); 
			GC0329_write_cmos_sensor(0x31, 0x03);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xc0); 
			GC0329_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x06, 0x32); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x3e);
			...
			GC0329_write_cmos_sensor(0x2c, 0x26); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x58); 
			GC0329_write_cmos_sensor(0x2f, 0x02);   //exp level 0  10.00fps //320
			GC0329_write_cmos_sensor(0x30, 0x58); 
			GC0329_write_cmos_sensor(0x31, 0x03);   //exp level 0  7.05fps
			GC0329_write_cmos_sensor(0x32, 0xe8); 
			GC0329_SET_PAGE0;
		break;
		default:
			GC0329_write_cmos_sensor(0x05, 0x01); 	
			...
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0xd0); 
			GC0329_write_cmos_sensor(0x2f, 0x02);   //exp level 2  10.00fps
			GC0329_write_cmos_sensor(0x30, 0xd0); 
			GC0329_write_cmos_sensor(0x31, 0x03);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xc0); 
			GC0329_SET_PAGE0;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	kal_uint8 value_luma, value_Y;
		value_luma = (GC0329_NIGHT_MODE?0x2b:0x00);//0x2b:0x00 
		value_Y = (GC0329_NIGHT_MODE?0x80:0x60);//0x68:0x50//zhao.li@tcl change from 0x68 to 0x6c

	switch (para)
	{
		case AE_EV_COMP_n13:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_n13--------\n");
		...
		case AE_EV_COMP_n10:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_n10--------\n");
		...
		case AE_EV_COMP_n07:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_n07--------\n");
		...
		case AE_EV_COMP_n03:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_n03--------\n");
		...
		case AE_EV_COMP_00:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_00--------\n");
		...
		case AE_EV_COMP_03:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_03--------\n");
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x10);
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y + 0x10);
			GC0329_write_cmos_sensor(0xfe, 0x00);
		...
		case AE_EV_COMP_07:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_07--------\n");
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x20);
			GC0329_write_cmos_sensor(0xfe, 0x01);
		...
		case AE_EV_COMP_10:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_10--------\n");
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x30);
			GC0329_write_cmos_sensor(0xfe, 0x01);
		...
		case AE_EV_COMP_13:
			printk("--------GC0329_set_param_exposure AE_EV_COMP_13--------\n");
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x48);
			GC0329_write_cmos_sensor(0xfe, 0x01);
		...
		break;
		default:
			printk("--------GC0329_set_param_exposure default--------\n");
		return FALSE;
	}
...
#if 1 //[573206] [Soul4][TV] Add DTV NMI5625 driver by lizhao @ 2014.01.10
//extern UINT32 NMI60X_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//SENSOR_FUNCTION_STRUCT	SensorFuncNMI60X;
extern SENSOR_FUNCTION_STRUCT	SensorFuncNMI60X;
#endif
//zhao.li@tcl ATV end
#endif
...
UINT32 GC0329_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	...
	if (g_bIsAtvStart) {
		...
		if(mt_set_gpio_out(GPIO_CAMERA_CMRST1_PIN,0)){printk("[CAMERA SENSOR] set gpio failed!! \n");} //low == reset sensor
		if(mt_set_gpio_out(GPIO_CAMERA_CMPDN1_PIN,1)){printk("[CAMERA LENS] set gpio failed!! \n");} //high == power down lens module
#endif
