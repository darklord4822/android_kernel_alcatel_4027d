...
/*IMX*/
...
#if defined(S5K5EAYX_MIPI_YUV)
		{S5K5EAYXMIPI_SENSOR_ID, SENSOR_DRVNAME_S5K5EAYX_MIPI_YUV, S5K5EAYX_MIPI_YUV_SensorInit}, 
#endif
    ...
    {NMI60X_SENSOR_ID, SENSOR_DRVNAME_NMI60X_YUV, NMI60X_YUV_SensorInit}, /*zhao.l.i@tcl TV*/
#endif
