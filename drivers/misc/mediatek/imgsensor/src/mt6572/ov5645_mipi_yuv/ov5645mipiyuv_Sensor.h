...
/* sensor size */
#define OV5645MIPI_IMAGE_SENSOR_SVGA_WIDTH          (1280-16)//1280-4
#define OV5645MIPI_IMAGE_SENSOR_SVGA_HEIGHT         (960-12) //960-3
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_WITDH         (2560-32)//(2592-16) 
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_HEIGHT        (1920-24)//(1944-12)
#define OV5645MIPI_IMAGE_SENSOR_VIDEO_WITDH         (1280-16)//1280-4 
#define OV5645MIPI_IMAGE_SENSOR_VIDEO_HEIGHT        (960-12) //960-3
...
#define OV5645MIPI_PV_PERIOD_PIXEL_NUMS    		(1280)  	/* Default preview line length HTS*/
#define OV5645MIPI_PV_PERIOD_LINE_NUMS     		(960)   	/* Default preview frame length  VTS*/
#define OV5645MIPI_FULL_PERIOD_PIXEL_NUMS  		(2560)  	/* Default full size line length */
#define OV5645MIPI_FULL_PERIOD_LINE_NUMS   		(1920)  	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define OV5645MIPI_PV_EXPOSURE_LIMITATION      	(960-4)
#define OV5645MIPI_FULL_EXPOSURE_LIMITATION    	(1920-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define OV5645MIPI_PV_GRAB_START_X 				   (4)
#define OV5645MIPI_PV_GRAB_START_Y  			(4)
#define OV5645MIPI_FULL_GRAB_START_X   			(8)
#define OV5645MIPI_FULL_GRAB_START_Y	  		(8)
