 ...
 * --------------------------------------------------------------------------------------
 * 14/02/22      Ni Qiangbo      Modify driver for Yaris4.5 3rd sensor module (LiteArray)
...
static int sensor_module;	//qiangbo.ni add for camera sensor 3rd module 2014-02-22
...
{	
    ...
    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_1]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_2]==TRUE)    { temp=temp|0x80;}
    //write 0x5688
    OV5645MIPI_write_cmos_sensor(0x5688,temp);
    
    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_3]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_4]==TRUE)    { temp=temp|0x80;}
    //write 0x5689
    OV5645MIPI_write_cmos_sensor(0x5689,temp);

    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_5]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_6]==TRUE)    { temp=temp|0x80;}
    //write 0x568A
    OV5645MIPI_write_cmos_sensor(0x568A,temp);
    
    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_7]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_8]==TRUE)    { temp=temp|0x80;}
    //write 0x568B
    OV5645MIPI_write_cmos_sensor(0x568B,temp);

    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_9]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_10]==TRUE)  { temp=temp|0x80;}
	//write 0x568C
    OV5645MIPI_write_cmos_sensor(0x568C,temp);

    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_11]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_12]==TRUE)    { temp=temp|0x80;}
    //write 0x568D
    OV5645MIPI_write_cmos_sensor(0x568D,temp);    
    
    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_13]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_14]==TRUE)    { temp=temp|0x80;}
	//write 0x568E
    OV5645MIPI_write_cmos_sensor(0x568E,temp);

    temp=0x11;
    if(AE_1_ARRAY[AE_SECTION_INDEX_15]==TRUE)    { temp=temp|0x08;}
    if(AE_1_ARRAY[AE_SECTION_INDEX_16]==TRUE)    { temp=temp|0x80;}
	//write 0x568F
...
//BEGIN: add by xiaopu.zhu for show camera info in MINISW screen,
	sprintf(Back_Camera_Name,"Vender:  Qtech \nSensor ID:  0x%X \nSensor name:  OV5645 \nResolution:  5M ",
...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3031, 0x00);//	zhouliao:from 0x08	//
	...
	OV5645MIPI_write_cmos_sensor(0x3400, 0x06);// r
	OV5645MIPI_write_cmos_sensor(0x3401, 0x23); 
	OV5645MIPI_write_cmos_sensor(0x3402, 0x04);// g
	OV5645MIPI_write_cmos_sensor(0x3403, 0x00); 
	OV5645MIPI_write_cmos_sensor(0x3404, 0x05);// b
	OV5645MIPI_write_cmos_sensor(0x3405, 0xE9); 
	...
	OV5645MIPI_write_cmos_sensor(0x5587,0x08); //0~0xff 值越大越白
	...
	OV5645MIPI_write_cmos_sensor(0x5180, 0xff);//ff ;awb
	OV5645MIPI_write_cmos_sensor(0x5181, 0xf2);//f2
	OV5645MIPI_write_cmos_sensor(0x5182, 0x0 );//0 
	OV5645MIPI_write_cmos_sensor(0x5183, 0x14);//14
	OV5645MIPI_write_cmos_sensor(0x5184, 0x25);//25
	OV5645MIPI_write_cmos_sensor(0x5185, 0x24);//24
	OV5645MIPI_write_cmos_sensor(0x5186, 0x16);//14 cwf ss
	OV5645MIPI_write_cmos_sensor(0x5187, 0x17);//17
	OV5645MIPI_write_cmos_sensor(0x5188, 0xf );//f 
	OV5645MIPI_write_cmos_sensor(0x5189, 0x77);//78
	OV5645MIPI_write_cmos_sensor(0x518a, 0x5b);//5c
	OV5645MIPI_write_cmos_sensor(0x518b, 0xf2);//f2
	OV5645MIPI_write_cmos_sensor(0x518c, 0x95);//95
	OV5645MIPI_write_cmos_sensor(0x518d, 0x3a);//3a
	OV5645MIPI_write_cmos_sensor(0x518e, 0x2b);//2b
	OV5645MIPI_write_cmos_sensor(0x518f, 0x5c);//5c
	OV5645MIPI_write_cmos_sensor(0x5190, 0x45);//45
	OV5645MIPI_write_cmos_sensor(0x5191, 0xf8);//f8
	OV5645MIPI_write_cmos_sensor(0x5192, 0x4 );//4 
	OV5645MIPI_write_cmos_sensor(0x5193, 0x70);//70
	OV5645MIPI_write_cmos_sensor(0x5194, 0xf0);//f0
	OV5645MIPI_write_cmos_sensor(0x5195, 0xf0);//f0
	OV5645MIPI_write_cmos_sensor(0x5196, 0x3 );//3 
	OV5645MIPI_write_cmos_sensor(0x5197, 0x1 );//1 
	OV5645MIPI_write_cmos_sensor(0x5198, 0x6 );//6 
	OV5645MIPI_write_cmos_sensor(0x5199, 0x23);//2e
	OV5645MIPI_write_cmos_sensor(0x519a, 0x4 );//4 
	OV5645MIPI_write_cmos_sensor(0x519b, 0x0 );//0 
	OV5645MIPI_write_cmos_sensor(0x519c, 0x5 );//4 
	OV5645MIPI_write_cmos_sensor(0x519d, 0xE9);//2e
	OV5645MIPI_write_cmos_sensor(0x519e, 0x38);//38
	
    OV5645MIPI_write_cmos_sensor(0x5780, 0xfc);//dpc                         
	OV5645MIPI_write_cmos_sensor(0x5781, 0x13);// default value           
	OV5645MIPI_write_cmos_sensor(0x5782, 0x03);// default value           
	OV5645MIPI_write_cmos_sensor(0x5786, 0x20);// default 8               
	OV5645MIPI_write_cmos_sensor(0x5787, 0x40);// default 10 -- Add       
	OV5645MIPI_write_cmos_sensor(0x5788, 0x08);// default 10              
	OV5645MIPI_write_cmos_sensor(0x5789, 0x08);//1x ;white pixel threshold
	OV5645MIPI_write_cmos_sensor(0x578a, 0x02);//8x  -- set in 5783       
	OV5645MIPI_write_cmos_sensor(0x578b, 0x01);//12x -- set in 5784       
	OV5645MIPI_write_cmos_sensor(0x578c, 0x01);//128x                     
	OV5645MIPI_write_cmos_sensor(0x578d, 0x0c);//1x ;black pixel threshold
	OV5645MIPI_write_cmos_sensor(0x578e, 0x02);//8x  -- set in 5783       
	OV5645MIPI_write_cmos_sensor(0x578f, 0x01);//12x -- set in 5784       
	OV5645MIPI_write_cmos_sensor(0x5790, 0x01);//128x                     
	OV5645MIPI_write_cmos_sensor(0x5308, 0x25);//128x
	...
	OV5645MIPI_write_cmos_sensor(0x5385,0x7b);//80//74
	OV5645MIPI_write_cmos_sensor(0x5386,0x7e);//83//77
	OV5645MIPI_write_cmos_sensor(0x5387,0x8c);//91//84
	OV5645MIPI_write_cmos_sensor(0x5388,0x7f);//84//78
	OV5645MIPI_write_cmos_sensor(0x5389,0x0d);//0c
	...
	*/
	...
	OV5645MIPI_write_cmos_sensor(0x5385, 0x6f);//
	OV5645MIPI_write_cmos_sensor(0x5386, 0x73);//
	OV5645MIPI_write_cmos_sensor(0x5387, 0x7f);//
	OV5645MIPI_write_cmos_sensor(0x5388, 0x73);//
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x20);//	; sharpen MT off1  
	OV5645MIPI_write_cmos_sensor(0x5303, 0x18);//	; sharpen MT off2
	...
	OV5645MIPI_write_cmos_sensor(0x5481, 0x0a);//	; Y yst 00
	OV5645MIPI_write_cmos_sensor(0x5482, 0x18);//
	OV5645MIPI_write_cmos_sensor(0x5483, 0x30);//
	OV5645MIPI_write_cmos_sensor(0x5484, 0x58);//
	OV5645MIPI_write_cmos_sensor(0x5485, 0x66);//
	OV5645MIPI_write_cmos_sensor(0x5486, 0x76);//
	OV5645MIPI_write_cmos_sensor(0x5487, 0x80);//
	OV5645MIPI_write_cmos_sensor(0x5488, 0x8a);//
	OV5645MIPI_write_cmos_sensor(0x5489, 0x94);//
	OV5645MIPI_write_cmos_sensor(0x548a, 0x9f);//
	OV5645MIPI_write_cmos_sensor(0x548b, 0xae);//
	OV5645MIPI_write_cmos_sensor(0x548c, 0xbb);//
	OV5645MIPI_write_cmos_sensor(0x548d, 0xcd);//
	OV5645MIPI_write_cmos_sensor(0x548e, 0xde);//
	...
	/*
    OV5645MIPI_write_cmos_sensor(0x5800, 0x34);//2f//lsc                                
	OV5645MIPI_write_cmos_sensor(0x5801, 0x16);//                                   
	OV5645MIPI_write_cmos_sensor(0x5802, 0x13);//                                   
	OV5645MIPI_write_cmos_sensor(0x5803, 0x12);//                                   
	OV5645MIPI_write_cmos_sensor(0x5804, 0x18);//                                   
	OV5645MIPI_write_cmos_sensor(0x5805, 0x34);//2e                                   
	OV5645MIPI_write_cmos_sensor(0x5806, 0x10);//                                   
	OV5645MIPI_write_cmos_sensor(0x5807, 0xa );//                                   
	OV5645MIPI_write_cmos_sensor(0x5808, 0x6 );//                                   
	OV5645MIPI_write_cmos_sensor(0x5809, 0x6 );//                                   
	OV5645MIPI_write_cmos_sensor(0x580a, 0xa );//                                   
	OV5645MIPI_write_cmos_sensor(0x580b, 0xf );//                                   
	OV5645MIPI_write_cmos_sensor(0x580c, 0xb );//                                   
	...
	OV5645MIPI_write_cmos_sensor(0x5811, 0xa );//                                   
	OV5645MIPI_write_cmos_sensor(0x5812, 0xb );//                                  
	OV5645MIPI_write_cmos_sensor(0x5813, 0x4 );//                                  
	OV5645MIPI_write_cmos_sensor(0x5814, 0x1 );//                                  
	OV5645MIPI_write_cmos_sensor(0x5815, 0x1 );//                                  
	OV5645MIPI_write_cmos_sensor(0x5816, 0x4 );//                                  
	OV5645MIPI_write_cmos_sensor(0x5817, 0xb );//                                  
	OV5645MIPI_write_cmos_sensor(0x5818, 0x12);//                                  
	OV5645MIPI_write_cmos_sensor(0x5819, 0x9 );//                                  
	OV5645MIPI_write_cmos_sensor(0x581a, 0x7 );//                                  
	OV5645MIPI_write_cmos_sensor(0x581b, 0x7 );//                                  
	OV5645MIPI_write_cmos_sensor(0x581c, 0xa );//                                  
	OV5645MIPI_write_cmos_sensor(0x581d, 0xf );//                                  
	OV5645MIPI_write_cmos_sensor(0x581e, 0x32);//                                  
	OV5645MIPI_write_cmos_sensor(0x581f, 0x1a);//
	OV5645MIPI_write_cmos_sensor(0x5820, 0x15);//
	OV5645MIPI_write_cmos_sensor(0x5821, 0x14);//
	OV5645MIPI_write_cmos_sensor(0x5822, 0x1a);//
	OV5645MIPI_write_cmos_sensor(0x5823, 0x38);//
	OV5645MIPI_write_cmos_sensor(0x5824, 0x48);//
	OV5645MIPI_write_cmos_sensor(0x5825, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x5826, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x5827, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x5828, 0x28);//
	OV5645MIPI_write_cmos_sensor(0x5829, 0x1c);//0a
	OV5645MIPI_write_cmos_sensor(0x582a, 0x26);//
	OV5645MIPI_write_cmos_sensor(0x582b, 0x36);//24
	OV5645MIPI_write_cmos_sensor(0x582c, 0x26);//
	OV5645MIPI_write_cmos_sensor(0x582d, 0x1c);//0a
	OV5645MIPI_write_cmos_sensor(0x582e, 0x2a);//
	OV5645MIPI_write_cmos_sensor(0x582f, 0x42);//
	OV5645MIPI_write_cmos_sensor(0x5830, 0x40);//
	OV5645MIPI_write_cmos_sensor(0x5831, 0x22);//
	OV5645MIPI_write_cmos_sensor(0x5832, 0x8 );//
	OV5645MIPI_write_cmos_sensor(0x5833, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x5834, 0x28);//
	OV5645MIPI_write_cmos_sensor(0x5835, 0x26);//
	OV5645MIPI_write_cmos_sensor(0x5836, 0x26);//
	OV5645MIPI_write_cmos_sensor(0x5837, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x5838, 0x6a);//
	OV5645MIPI_write_cmos_sensor(0x5839, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x583a, 0x2c);//
	OV5645MIPI_write_cmos_sensor(0x583b, 0x2a);//
	OV5645MIPI_write_cmos_sensor(0x583c, 0x26);//
	OV5645MIPI_write_cmos_sensor(0x583d, 0xce);//
	OV5645MIPI_write_cmos_sensor(0x583e, 0x10);//
	OV5645MIPI_write_cmos_sensor(0x583f, 0x08);//
	*/
OV5645MIPI_write_cmos_sensor(0x5800,0x19);
OV5645MIPI_write_cmos_sensor(0x5801,0x14);
OV5645MIPI_write_cmos_sensor(0x5802,0x10);
OV5645MIPI_write_cmos_sensor(0x5803,0x10);
OV5645MIPI_write_cmos_sensor(0x5804,0x14);
OV5645MIPI_write_cmos_sensor(0x5805,0x19);
OV5645MIPI_write_cmos_sensor(0x5806,0x0E);
OV5645MIPI_write_cmos_sensor(0x5807,0x0A);
OV5645MIPI_write_cmos_sensor(0x5808,0x07);
OV5645MIPI_write_cmos_sensor(0x5809,0x07);
OV5645MIPI_write_cmos_sensor(0x580A,0x0A);
OV5645MIPI_write_cmos_sensor(0x580B,0x0F);
...
OV5645MIPI_write_cmos_sensor(0x5810,0x04);
OV5645MIPI_write_cmos_sensor(0x5811,0x09);
OV5645MIPI_write_cmos_sensor(0x5812,0x09);
OV5645MIPI_write_cmos_sensor(0x5813,0x04);
OV5645MIPI_write_cmos_sensor(0x5814,0x01);
OV5645MIPI_write_cmos_sensor(0x5815,0x01);
...
OV5645MIPI_write_cmos_sensor(0x581A,0x07);
OV5645MIPI_write_cmos_sensor(0x581B,0x07);
OV5645MIPI_write_cmos_sensor(0x581C,0x0A);
OV5645MIPI_write_cmos_sensor(0x581D,0x0F);
OV5645MIPI_write_cmos_sensor(0x581E,0x19);
OV5645MIPI_write_cmos_sensor(0x581F,0x14);
OV5645MIPI_write_cmos_sensor(0x5820,0x10);
OV5645MIPI_write_cmos_sensor(0x5821,0x10);
OV5645MIPI_write_cmos_sensor(0x5822,0x14);
OV5645MIPI_write_cmos_sensor(0x5823,0x1B);
OV5645MIPI_write_cmos_sensor(0x5824,0x77);
OV5645MIPI_write_cmos_sensor(0x5825,0x3C);
OV5645MIPI_write_cmos_sensor(0x5826,0x2E);
OV5645MIPI_write_cmos_sensor(0x5827,0x3C);
OV5645MIPI_write_cmos_sensor(0x5828,0x77);
OV5645MIPI_write_cmos_sensor(0x5829,0x1C);
OV5645MIPI_write_cmos_sensor(0x582A,0x17);
OV5645MIPI_write_cmos_sensor(0x582B,0x15);
OV5645MIPI_write_cmos_sensor(0x582C,0x18);
OV5645MIPI_write_cmos_sensor(0x582D,0x3C);
OV5645MIPI_write_cmos_sensor(0x582E,0x0B);
OV5645MIPI_write_cmos_sensor(0x582F,0x13);
OV5645MIPI_write_cmos_sensor(0x5830,0x30);
OV5645MIPI_write_cmos_sensor(0x5831,0x33);
OV5645MIPI_write_cmos_sensor(0x5832,0x2B);
OV5645MIPI_write_cmos_sensor(0x5833,0x1C);
OV5645MIPI_write_cmos_sensor(0x5834,0x17);
OV5645MIPI_write_cmos_sensor(0x5835,0x15);
OV5645MIPI_write_cmos_sensor(0x5836,0x17);
OV5645MIPI_write_cmos_sensor(0x5837,0x2C);
OV5645MIPI_write_cmos_sensor(0x5838,0x66);
OV5645MIPI_write_cmos_sensor(0x5839,0x3C);
OV5645MIPI_write_cmos_sensor(0x583A,0x2E);
OV5645MIPI_write_cmos_sensor(0x583B,0x2D);
OV5645MIPI_write_cmos_sensor(0x583C,0x76);
OV5645MIPI_write_cmos_sensor(0x583D,0xDD);
	...
	OV5645MIPI_write_cmos_sensor(0x3a0f, 0x30);//	27; AEC in H
	OV5645MIPI_write_cmos_sensor(0x3a10, 0x28);//	21; AEC in L
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x60);//	4f; AEC out H
	OV5645MIPI_write_cmos_sensor(0x3a1b, 0x30);//	27; AEC out L
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x28);//	21; control zone H
	OV5645MIPI_write_cmos_sensor(0x3a1f, 0x14);//	11; control zone L  
	}
	else
	{
	OV5645MIPISENSORDB("[OV5645MIPI]enter OV5645MIPIInitialSetting function:\n ");
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	if(0 == sensor_module)
	{
	OV5645MIPI_write_cmos_sensor(0x5302, 0x18);//	; sharpen MT
	OV5645MIPI_write_cmos_sensor(0x5303, 0x10);//	; sharpen MT 
	OV5645MIPI_write_cmos_sensor(0x5306, 0x18);//	; DNS off1  08+4
	OV5645MIPI_write_cmos_sensor(0x5307, 0x20);//	; DNS off2  10+4
	}
	else
	{
	OV5645MIPI_write_cmos_sensor(0x5302, 0x18);//	; sharpen MT
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x47);//	; flip off, V bin off
	OV5645MIPI_write_cmos_sensor(0x3821, 0x01);//	; mirror on, H bin off
	...
	OV5645MIPI_write_cmos_sensor(0x5306, 0x0c);//	; DNS off1  
	OV5645MIPI_write_cmos_sensor(0x5307, 0x14);//	; DNS off2 
	if(run_test_potten)
	{
		run_test_potten=0;
		OV5645SetTestPatternMode(1);
...
static void OV5645MIPIFullSizeZSDSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3821, 0x01);//	; mirror on, H bin off
	OV5645MIPI_write_cmos_sensor(0x4514, 0x88);
	OV5645MIPI_write_cmos_sensor(0x3a02, 0x10);//	; max exp 60 = 740
	OV5645MIPI_write_cmos_sensor(0x3a03, 0x24);//	; max exp 60
	OV5645MIPI_write_cmos_sensor(0x3a14, 0x10);//	; max exp 50 = 740
	OV5645MIPI_write_cmos_sensor(0x3a15, 0x24);//	; max exp 50
	OV5645MIPI_write_cmos_sensor(0x3c07, 0x07);//	; 50/60 auto detect
	OV5645MIPI_write_cmos_sensor(0x3c08, 0x01);//	; 50/60 auto detect
	OV5645MIPI_write_cmos_sensor(0x3c09, 0xc2);//	; 50/60 auto detect
	OV5645MIPI_write_cmos_sensor(0x3a0e, 0x06);//	; flip off, V bin off
	...
	if(0 == sensor_module)
	{
	OV5645MIPI_write_cmos_sensor(0x5302, 0x24);//	; sharpen MT
	OV5645MIPI_write_cmos_sensor(0x5303, 0x1c);//	; sharpen MT 
	OV5645MIPI_write_cmos_sensor(0x5306, 0x0c);//	; DNS off1  
	OV5645MIPI_write_cmos_sensor(0x5307, 0x14);//	; DNS off2 
	}
	else
...
* GLOBALS AFFECTED
*************************************************************************/	
static void OV5645WBcalibattion(kal_uint32 color_r_gain,kal_uint32 color_g_gain,kal_uint32 color_b_gain)
{
		kal_uint32 color_r_gain_w = 0x400;
		kal_uint32 color_g_gain_w = 0x400;
		kal_uint32 color_b_gain_w = 0x400;
...
// xiaopu.zhu add for camera sensor module compatible start
    sensor_module = mt_get_gpio_in(GPIO_MAIN_CAMERA_ID_PIN);
	if(1== sensor_module)  //jiangjingjing modify 20150120 according to HW require
	{
		printk("%s :  high 1st Module .\n", __func__);
	}
	else
	{
		printk("%s : low 2nd Module .\n", __func__);
	}
//xiaopu.zhu add for  camera sensor module compatible end
...
UINT32 OV5645MIPICapture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	kal_uint32 color_r_gain =0x400;
	kal_uint32 color_g_gain =0x400;
  	kal_uint32 color_b_gain =0x400;
	...
	{		
		...
		color_g_gain=((OV5645MIPIYUV_read_cmos_sensor(0x3403)&0xFF)+((OV5645MIPIYUV_read_cmos_sensor(0x3402)&0xFF)*256)); 
		color_b_gain=((OV5645MIPIYUV_read_cmos_sensor(0x3405)&0xFF)+((OV5645MIPIYUV_read_cmos_sensor(0x3404)&0xFF)*256)); 
		OV5645MIPIFullSizeCaptureSetting();
		spin_lock(&ov5645mipi_drv_lock);	
		OV5645MIPISensor.SensorMode= SENSOR_MODE_CAPTURE;
		spin_unlock(&ov5645mipi_drv_lock);
		OV5645WBcalibattion(color_r_gain,color_g_gain,color_b_gain);  	
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->AEShutDelayFrame= 3;
	...
	switch (para)
    {
        ...
        case AWB_MODE_FLUORESCENT:
					if(0 == sensor_module)
					{
							...
							OV5645MIPI_set_AWB_mode(KAL_FALSE);                           
							OV5645MIPI_write_cmos_sensor(0x3400,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3401,0x30); //0x00
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); 
							OV5645MIPI_write_cmos_sensor(0x3404,0x06); 
							OV5645MIPI_write_cmos_sensor(0x3405,0x80); //0x50                           
							//OV5645MIPI_write_cmos_sensor(0x3212,0x12); 
        	    			//OV5645MIPI_write_cmos_sensor(0x3212,0xa2);                        
					}
					else
...
void OV5645MIPI_scene_mode_PORTRAIT()
{
	...
	OV5645MIPI_write_cmos_sensor(0x5382,0x55);//
	OV5645MIPI_write_cmos_sensor(0x5383,0x12);//
	OV5645MIPI_write_cmos_sensor(0x5384,0x8 );//0x23
	OV5645MIPI_write_cmos_sensor(0x5385,0x68);//0x4b
	OV5645MIPI_write_cmos_sensor(0x5386,0x70);//0x6f
	OV5645MIPI_write_cmos_sensor(0x5387,0x7a);//0x76
	OV5645MIPI_write_cmos_sensor(0x5388,0x80);//0x9a
	OV5645MIPI_write_cmos_sensor(0x5389,0x14);//0x25
	OV5645MIPI_write_cmos_sensor(0x538a,0x01);//
	OV5645MIPI_write_cmos_sensor(0x538b,0x98);//	
	}
	else
...
void OV5645MIPI_scene_mode_SUNSET()
{
	...
	if( 0 ==sensor_module)
	{
	OV5645MIPI_write_cmos_sensor(0x5381,0x22); //0x42   //ccm
	OV5645MIPI_write_cmos_sensor(0x5382,0x55); //0x5a
	OV5645MIPI_write_cmos_sensor(0x5383,0x12); //0x08
	OV5645MIPI_write_cmos_sensor(0x5384,0x8 ); //0x20
	OV5645MIPI_write_cmos_sensor(0x5385,0x68); //0x7e
	OV5645MIPI_write_cmos_sensor(0x5386,0x70); //0x48
	OV5645MIPI_write_cmos_sensor(0x5387,0x8a); //0xbc
	OV5645MIPI_write_cmos_sensor(0x5388,0x78); //0x6c
	OV5645MIPI_write_cmos_sensor(0x5389,0x10); //0x06
	OV5645MIPI_write_cmos_sensor(0x538a,0x01);//
	OV5645MIPI_write_cmos_sensor(0x538b,0x98); //0x9c  	
	}
	else
	{
	OV5645MIPI_write_cmos_sensor(0x5381,0x22); //0x42   //ccm
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AE_ISO_400:
             ...
             break;
	case AE_ISO_800:  //jiangjingjing-add-for-defect-124331-20140120-begin
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0xe0);
	    break;
       case AE_ISO_1600:
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0xF8);
            break;        //jiangjingjing-add-for-defect-124331-20140120-end
        default:
             break;
    }
    return;
...
BOOL OV5645MIPI_set_param_exposure(UINT16 para)
{
    ...
    SENSOR_MODE_CAPTURE == OV5645MIPISensor.SensorMode)
   {
	...
	switch (para)
    {	    
        case AE_EV_COMP_30:	          //jiangjingjing-add-for-defect-124333-20140120-begin         
				OV5645MIPI_write_cmos_sensor(0x3a0f, 0x80);//	; AEC in H
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x78);//	; AEC in L
				OV5645MIPI_write_cmos_sensor(0x3a11, 0xb0);//	; AEC out H
				OV5645MIPI_write_cmos_sensor(0x3a1b, 0x80);//	; AEC out L
				OV5645MIPI_write_cmos_sensor(0x3a1e, 0x78);//	; control zone H
				OV5645MIPI_write_cmos_sensor(0x3a1f, 0x44);//	; control zone L   
				break;             //jiangjingjing-add-for-defect-124333-20140120-end
	   case AE_EV_COMP_20:	                   
		...
		case AE_EV_COMP_00:
      	...
      	case AE_EV_COMP_n20:  // -2 EV
        	 ...
        	 break;
	 case AE_EV_COMP_n30:	//jiangjingjing-add-for-defect-124333-20140120-begin                      
				OV5645MIPI_write_cmos_sensor(0x3a0f, 0x0e);//	; AEC in H
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x08);//	; AEC in L
				OV5645MIPI_write_cmos_sensor(0x3a11, 0x2c);//	; AEC out H
				OV5645MIPI_write_cmos_sensor(0x3a1b, 0x0e);//	; AEC out L
				OV5645MIPI_write_cmos_sensor(0x3a1e, 0x08);//	; control zone H
				OV5645MIPI_write_cmos_sensor(0x3a1f, 0x01);//	; control zone L   
				break;          //jiangjingjing-add-for-defect-124333-20140120-end  
        default:
               break;
    }
